...
public class MessageDto implements Serializable {
	private static final long serialVersionUID = 7669412884705013818L;
	...
	public void showPrompt(String idPromptInput, String promptTitle, String promptDefault, boolean required, String idOk) {
	...
	public boolean isShowMessage() {
		return !infoMessages.isEmpty() || !confMessages.isEmpty() || !warnMessages.isEmpty()
				|| !errorMessages.isEmpty() || !fatalMessages.isEmpty();
	}
