...
@Entity
@NamedQueries({
		@NamedQuery(name = "RoleBusiness.findMainAll", query = "select o from RoleMenu o inner join Menu m on (o.menuId = m.id) where o.deleted = 0 and m.deleted = 0 and m.main = 1 and o.roleId = :roleId order by o.sort, m.sort"),
		@NamedQuery(name = "RoleBusiness.findSubAll", query = "select o from RoleMenu o inner join Menu m on (o.menuId = m.id) where o.deleted = 0 and m.deleted = 0 and m.main = 0 and o.roleId = :roleId and m.mainId = :mainId order by o.sort, m.sort") })
@Table(name = "role_business")
public class RoleBusiness extends DaoEntity implements Serializable {
