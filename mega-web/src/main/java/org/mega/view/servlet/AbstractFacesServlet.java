...
public abstract class AbstractFacesServlet extends HttpServlet {
	private static final long serialVersionUID = -5613049864441667878L;
	...
	protected Object getManagedBean(String beanName, FacesContext facesContext) {
		return getApplication(facesContext).evaluateExpressionGet(facesContext, "#{" + beanName + "}", Object.class);
	}
